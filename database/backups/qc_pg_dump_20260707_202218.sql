...
SELECT pg_catalog.setval('public.form_evals_id_seq', 17, true);
...
SELECT pg_catalog.setval('public.form_groups_id_seq', 10, true);
...
SELECT pg_catalog.setval('public.measurement_details_id_seq', 55, true);
...
SELECT pg_catalog.setval('public.norms_id_seq', 7, true);
...
SELECT pg_catalog.setval('public.receptions_id_seq', 73, true);
...
SELECT pg_catalog.setval('public.receptions_id_seq1', 24, true);
...
SELECT pg_catalog.setval('public.reports_id_seq', 30, true);
...
SELECT pg_catalog.setval('public.spec_headers_id_seq', 19, true);
...
SELECT pg_catalog.setval('public.spec_test_evals_id_seq', 227, true);
...
SELECT pg_catalog.setval('public.tests_id_seq', 58, true);
