...
INSERT INTO public.certificates OVERRIDING SYSTEM VALUE VALUES (9, 72, 18, false, true, 1, '2026-07-07 20:05:58.791421+03', 'All testing results are according to specification
------------
Veritatis itaque quis soluta labore tenetur', NULL, false, NULL, NULL, NULL);
INSERT INTO public.certificates OVERRIDING SYSTEM VALUE VALUES (10, 73, 19, false, true, 1, '2026-07-07 20:07:20.403415+03', 'All testing results are according to specification
------------
...
INSERT INTO public.users OVERRIDING SYSTEM VALUE VALUES (1, 'alice', 'AL', 'alice@qc.lab', 'Alice', NULL, true, true, true, '$2b$12$2r5/qy12nsTXwZCtEAO/8.G1GimD5JzdgCjMqvtUlRGYHQldOcaNC', '204b3731437142bd9e914c3accc943be', false, '2025-12-13 18:17:42.218999+02', '145ef059-ceaa-49c6-8c24-11df69feb730', '2026-07-09 15:07:43.635518+03', '2026-07-10 03:07:43.635635+03', NULL, '2025-12-13 18:17:42.218999+02', false, NULL, NULL);
...
SELECT pg_catalog.setval('public.certification_headers_id_seq', 10, true);
...
SELECT pg_catalog.setval('public.form_evals_id_seq', 18, true);
...
SELECT pg_catalog.setval('public.form_groups_id_seq', 11, true);
...
SELECT pg_catalog.setval('public.measurement_details_id_seq', 56, true);
...
SELECT pg_catalog.setval('public.norms_id_seq', 8, true);
...
SELECT pg_catalog.setval('public.receptions_id_seq', 74, true);
...
SELECT pg_catalog.setval('public.receptions_id_seq1', 25, true);
...
SELECT pg_catalog.setval('public.spec_headers_id_seq', 20, true);
...
SELECT pg_catalog.setval('public.spec_test_evals_id_seq', 249, true);
