...
import CategoryVerificationDialog from './CategoryVerificationDialog';
...
import styles from './CategoryVerificationDetailView.module.css';
...
const CategoryVerificationDetailView: React.FC<Props> = ({ 
  receptionId, 
  onClose, 
  breadcrumbs, 
  allTests, 
  ...
  return (
    <DetailView>
      <DetailViewHeader 
        title={`Category Verification Reception ${reception.id} (${reception.status})`} 
        onBack={onClose} 
        ...
        <div className="reception-form">
          <DetailContainer>
            <DetailColumn title="Info">
              <DetailItem label="Material Name" value={reception.materialName} />
              <DetailItem label="Category" value={reception.categoryName} />
...
export default CategoryVerificationDetailView;
