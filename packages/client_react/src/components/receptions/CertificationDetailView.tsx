...
import styles from './CertificationDetailView.module.css';
...
const CertificationDetailView: React.FC<Props> = ({ 
  receptionId, 
  onClose, 
  breadcrumbs, 
  allTests, 
  ...
  return (
    <DetailView>
      <DetailViewHeader 
        title={`Certification Reception ${reception.id} (${reception.status})`} 
        onBack={onClose} 
